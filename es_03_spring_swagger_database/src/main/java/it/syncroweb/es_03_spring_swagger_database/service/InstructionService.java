...
public class InstructionService {
    ...
    public ResponseEntity<List<Instruction>> addAllInstruction(List<Instruction> instructions) {
        try {
            List<Instruction> instructions1 = instructionRepository.saveAll(instructions);
